...
const CurriculumManager = (() => {
  const STAGES = [
    ...
    { name: 'Fluency & Story Reading',    description: 'Fluency practice, stories, assessments, and parent tools', activities: ['story-time','read-advanced','consonant-blends','sentence-reading','phonics-review','assessment-level-1','assessment-level-2','parent-dashboard','ai-reading-tutor'], requiredCompletions: 4, premium: true },
  ];
